...
public class Admin extends UserPanel {
    ...
    public static void editTour() {
        ...
        try {
            ...
            Scanner scanner = new Scanner(System.in);
            System.out.println("\nEnter the city number to edit tours: ");
            int selectedCityNumber = Integer.parseInt(scanner.nextLine());
            ...
            if (selectedCity != null) {
                ...
                System.out.println("Enter the tour number you want to edit: ");
                ...
                if (selectedTour != null) {
                    ...
                    System.out.println("\nEnter the new information for the tour:");
                    ...
                    System.out.println("Enter the price: ");
                    selectedTour.put("price", scanner.nextLine());
